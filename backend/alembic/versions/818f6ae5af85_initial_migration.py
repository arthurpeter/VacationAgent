...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_blacklist_tokens_token"), "blacklist_tokens", ["token"], unique=False
    )
    op.create_table(
        "global_attractions",
    ...
    op.create_index(
        op.f("ix_global_attractions_category"),
        "global_attractions",
        ["category"],
        unique=False,
    )
    op.create_index(
        op.f("ix_global_attractions_city"), "global_attractions", ["city"], unique=False
    )
    op.create_index(
        op.f("ix_global_attractions_country"),
        "global_attractions",
        ["country"],
        unique=False,
    )
    op.create_index(
        op.f("ix_global_attractions_external_place_id"),
        "global_attractions",
        ["external_place_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_global_attractions_id"), "global_attractions", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_global_attractions_official_name"),
        "global_attractions",
        ["official_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_global_attractions_state_province"),
        "global_attractions",
        ["state_province"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_travel_companions_id"), "travel_companions", ["id"], unique=False
    )
    op.create_table(
        "vacation_sessions",
    ...
    op.create_index(
        op.f("ix_vacation_sessions_id"), "vacation_sessions", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_vacation_sessions_user_id"),
        "vacation_sessions",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_vacations_is_finalized"), "vacations", ["is_finalized"], unique=False
    )
    op.create_table(
        "vacation_companions",
        ...
        sa.ForeignKeyConstraint(
            ["companion_id"], ["travel_companions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["vacation_session_id"], ["vacation_sessions.id"], ondelete="CASCADE"
        ),
...
def downgrade() -> None:
    ...
    op.drop_table("users")
    op.drop_index(
        op.f("ix_global_attractions_state_province"), table_name="global_attractions"
    )
    op.drop_index(
        op.f("ix_global_attractions_official_name"), table_name="global_attractions"
    )
    op.drop_index(op.f("ix_global_attractions_id"), table_name="global_attractions")
    op.drop_index(
        op.f("ix_global_attractions_external_place_id"), table_name="global_attractions"
    )
    op.drop_index(
        op.f("ix_global_attractions_country"), table_name="global_attractions"
    )
    op.drop_index(op.f("ix_global_attractions_city"), table_name="global_attractions")
    op.drop_index(
        op.f("ix_global_attractions_category"), table_name="global_attractions"
    )
