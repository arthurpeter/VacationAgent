...
ALL_PARIS_POIS = [
    {
        "id": 10,
        "name": "Chapelle Sainte-Thérèse de Montmagny",
        "bucket": "optional",
        "latitude": 48.962120056152344,
        "longitude": 2.3322455883026123,
    ...
    {
        "id": 13,
        "name": "Stade de France Miniature",
        "bucket": "optional",
        "latitude": 48.776981353759766,
        "longitude": 1.962082028388977,
        "recommended_duration_mins": 240,
        "opening_hours": '{"monday": null, "tuesday": null, "wednesday": null, "thursday": null, "friday": null, "saturday": null, "sunday": null}',
    },
    {
        "id": 15,
        "name": "Parc Balbi",
        "bucket": "optional",
        "latitude": 48.79695510864258,
        "longitude": 2.1194443702697754,
    ...
    },
    {
        ...
        "name": "Eiffel Tower",
        "bucket": "must",
        "latitude": 48.8582878112793,
        "longitude": 2.2944986820220947,
    ...
    },
    {
        ...
        "bucket": "want",
        "latitude": 48.852935791015625,
        "longitude": 2.350050210952759,
    ...
    },
    {
        ...
        "name": "Louvre Museum",
        "bucket": "must",
        "latitude": 48.861148834228516,
        "longitude": 2.3380274772644043,
        "recommended_duration_mins": 180,
    ...
    },
    {
        ...
        "bucket": "want",
        "latitude": 48.855655670166016,
        "longitude": 2.3450512886047363,
        "recommended_duration_mins": 90,
    ...
    },
    {
        ...
        "bucket": "optional",
        "latitude": 48.883113861083984,
        "longitude": 2.3434195518493652,
        "recommended_duration_mins": 180,
        "opening_hours": '{"monday": "N/A", "tuesday": "N/A", "wednesday": "N/A", "thursday": "N/A", "friday": "N/A", "saturday": "N/A", "sunday": "N/A"}',
    },
    {
        "id": 31,
        "name": "Parc des Beaumonts",
        "bucket": "optional",
        "latitude": 48.85845184326172,
        "longitude": 2.453369140625,
        "recommended_duration_mins": 120,
    ...
    },
    {
        ...
        "bucket": "want",
        "latitude": 48.8716926574707,
        "longitude": 2.30460524559021,
        "recommended_duration_mins": 120,
        "opening_hours": '{"monday": "N/A", "tuesday": "N/A", "wednesday": "N/A", "thursday": "N/A", "friday": "N/A", "saturday": "N/A", "sunday": "N/A"}',
    },
    {
        ...
        "name": "Latin Quarter",
        "bucket": "must",
        "latitude": 48.84873962402344,
        "longitude": 2.342050075531006,
    ...
    {
        "id": 26,
        "name": "Dome of Les Invalids",
        "bucket": "want",
        "latitude": 48.85499572753906,
        "longitude": 2.312530517578125,
        "recommended_duration_mins": 180,
    ...
    },
    {
        ...
        "bucket": "optional",
        "latitude": 48.860591888427734,
        "longitude": 2.3524742126464844,
        "recommended_duration_mins": 180,
    ...
    },
    {
        ...
        "name": "Sacré-Cœur",
        "bucket": "must",
        "latitude": 48.88680648803711,
        "longitude": 2.343015193939209,
        "recommended_duration_mins": 120,
    ...
    },
    {
        ...
        "bucket": "optional",
        "latitude": 48.86366271972656,
        "longitude": 2.3268399238586426,
        "recommended_duration_mins": 120,
        "opening_hours": '{"monday": "N/A", "tuesday": "N/A", "wednesday": "N/A", "thursday": "N/A", "friday": "N/A", "saturday": "N/A", "sunday": "N/A"}',
    },
    {
        ...
        "bucket": "optional",
        "latitude": 48.849998474121094,
        "longitude": 2.3588900566101074,
        "recommended_duration_mins": 180,
        "opening_hours": '{"monday": "00:00-24:00", "tuesday": "00:00-24:00", "wednesday": "00:00-24:00", "thursday": "00:00-24:00", "friday": "00:00-24:00", "saturday": "00:00-24:00", "sunday": "00:00-24:00"}',
    },
    {
        ...
        "name": "Pont Neuf",
        "bucket": "optional",
        "latitude": 48.85652542114258,
        "longitude": 2.3408308029174805,
        "recommended_duration_mins": 60,
        "opening_hours": '{"monday": "00:00-23:59", "tuesday": "00:00-23:59", "wednesday": "00:00-23:59", "thursday": "00:00-23:59", "friday": "00:00-23:59", "saturday": "00:00-23:59", "sunday": "00:00-23:59"}',
    },
    {
        ...
        "name": "Palais Royal",
        "bucket": "optional",
        "latitude": 48.86358642578125,
        "longitude": 2.3362042903900146,
        "recommended_duration_mins": 120,
        "opening_hours": '{"monday": "N/A", "tuesday": "N/A", "wednesday": "N/A", "thursday": "N/A", "friday": "N/A", "saturday": "N/A", "sunday": "N/A"}',
    },
    {
        ...
        "bucket": "optional",
        "latitude": 48.855621337890625,
        "longitude": 2.3655426502227783,
        "recommended_duration_mins": 120,
        "opening_hours": '{"monday": "00:00-23:59", "tuesday": "00:00-23:59", "wednesday": "00:00-23:59", "thursday": "00:00-23:59", "friday": "00:00-23:59", "saturday": "00:00-23:59", "sunday": "00:00-23:59"}',
    },
]
...
def assert_schedule_integrity(result: dict, input_pois: list):
    ...
    for day in schedule:
        for event in day["events"]:
            if event["type"] == "attraction" and isinstance(event.get("id"), int):
                assert event["id"] not in scheduled_ids, (
                    f"Atractia {event['name']} este duplicata!"
                )
    ...
    assert scheduled_ids.union(excluded_ids) == input_ids, (
        "Scurgere de date: unele atractii au disparut complet!"
    )

    full_day_loads = []

    poi_duration_map = {
        p["id"]: p.get("recommended_duration_mins", 120) for p in input_pois
    }
    scheduled_durations = [
        poi_duration_map[pid] for pid in scheduled_ids if pid in poi_duration_map
    ]
    ...
    for day in schedule:
        ...
        if not is_transit_day:
            day_sightseeing_mins = sum(
                ...
                for e in events
                if e["type"] == "attraction" and isinstance(e.get("id"), int)
            )
        ...
        for i in range(len(events)):
            ...
            assert c_end >= c_start, (
                f"Eroare cronologica: {curr['name']} are durata negativa!"
            )

            if not is_transit_day:
                if curr["type"] == "attraction" and not str(curr.get("id")).startswith(
                    "return_"
                ):
                    assert c_end <= 20 * 60 + 30, (
                        f"Ritm incalcat: {curr['name']} depaseste ora maxima pentru vizitare!"
                    )
            ...
            if i > 0:
                ...
                assert c_start >= p_end, (
                    f"Suprapunere detectata intre {prev['name']} si {curr['name']}!"
                )
    ...
    if len(active_loads) > 1:
        ...
        assert std_deviation <= max_scheduled_duration, (
            ...
            f"Deviatia standard intre zile este de {std_deviation:.1f} minute, "
...
def assert_recalculation_integrity(result: dict, input_pois: list):
    ...
    for day in schedule:
        ...
        for curr in events:
            ...
            assert c_end >= c_start, (
                f"Eroare: Evenimentul {curr['name']} are durata negativa!"
            )
            ...
            if curr["type"] == "attraction" and isinstance(curr.get("id"), int):
                ...
                if (
                    opening_hours_str
                    and "closed" in opening_hours_str.lower()
                    and day_of_week in opening_hours_str.lower()
                ):
                    ...
                    if (
                        opening_hours_str
                        and "closed" in opening_hours_str.lower()
                        and "holiday" not in opening_hours_str.lower()
                    ):
                        if day_of_week not in opening_hours_str.lower():
                            assert curr["unknown_hours_warning"] is False, (
                                f"Avertisment fals-pozitiv generat pentru {curr['name']}!"
                            )

            assert c_start >= time_cursor, (
                f"Suprapunere fizica detectata la recalculare intre {prev['name']} si {curr['name']} in ziua {day_idx}!"
            )
            prev = curr
